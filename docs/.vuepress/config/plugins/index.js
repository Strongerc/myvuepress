module.exports = {
  ...
  // 您可以在VuePress的Markdown文件中使用流程图了
  'flowchart': {
  ...
  // Baidu autopush SEO plugin for vuepress. 百度站点自动推送 Vuepress 插件。（百度站长推送、百度站长平台提交链接、主动推送、自动推送） 
  ...
  // 动态title
  "dynamic-title": {
    showIcon: "/img/bike.png",
    showText: "(/≧▽≦/)欢迎回来！",
    hideIcon: "/img/bike.png",
